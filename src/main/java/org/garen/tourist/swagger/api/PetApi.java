...
import org.garen.tourist.swagger.model.ModelApiResponse;
...
public interface PetApi {
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful tourist", response = Pet.class),
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful tourist", response = ModelApiResponse.class) })
