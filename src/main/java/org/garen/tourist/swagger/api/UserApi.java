...
import org.garen.tourist.swagger.model.User;
...
public interface UserApi {
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful tourist", response = Void.class) })
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful tourist", response = User.class),
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful tourist", response = String.class),
